        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?= Url::home(); ?>/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?= Yii::$app->user->isGuest ? "Guest" : Yii::$app->user->identity->username ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?= Url::home(); ?>/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; dijekarim <?= date('Y') ?></p>
